...
const container_temp = document.querySelector('.conteiner-temp');
const temp_number = document.querySelector('.container-temp div');
const temp_unit = document.querySelector('.container-temp span');
const weather_t = document.querySelector('.weather');
const search_input = document.querySelector('.txt-Busca');
const search_button = document.querySelector('.btn-Busca');
const low_high = document.querySelector('.media');
...
function displayResults(weather) {
    ...
    container_img.innerHTML = `<img src="assents/icons/${iconName}.png">`;
